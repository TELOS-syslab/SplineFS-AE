...
/*
 * KUnit test of ext5 inode that verify the seconds part of [a/c/m]
 * timestamps in ext5 inode structs are decoded correctly.
 */
...
KUNIT_ARRAY_PARAM(ext5_inode, test_data, timestamp_expectation_to_desc);
 ...
 *  Documentation/filesystems/ext5/inodes.rst.
 */
static void inode_test_xtimestamp_decoding(struct kunit *test)
{
	...
	timestamp = ext5_decode_extra_time(
...
static struct kunit_case ext5_inode_test_cases[] = {
	KUNIT_CASE_PARAM(inode_test_xtimestamp_decoding, ext5_inode_gen_params),
	{}
};

static struct kunit_suite ext5_inode_test_suite = {
	.name = "ext5_inode_test",
	.test_cases = ext5_inode_test_cases,
};

kunit_test_suites(&ext5_inode_test_suite);

MODULE_DESCRIPTION("KUnit test of ext5 inode timestamp decoding");
